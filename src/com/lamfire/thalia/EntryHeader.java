 ...
 * <p/>
 * both values were stored as four-byte integers. This was very wastefull.
...
final class EntryHeader {
    ...
    private static final short O_AVAILABLESIZE = Const.SZ_BYTE; // int availableSize
    static final int MAX_RECORD_SIZE = 8355839;
    static final int SIZE = O_AVAILABLESIZE + Const.SZ_SHORT;
    /**
