 ...
 */
class MRUCachedThalia extends CachedThalia {
	 ...
	 * cache policy.
	 */
	public MRUCachedThalia(String filename, boolean readonly, boolean transactionDisabled, Cipher cipherIn, Cipher cipherOut, boolean useRandomAccessFile,
	...
	public synchronized <A> void update(final long recid, final A obj, final Serializer<A> serializer) throws IOException {
		...
		synchronized (_hash) {
			...
			// check if entry is in dirties, in this case just
			// update its object
	...
	public void clearCache() {
		if (debug){
			System.err.println(this.getClass().getSimpleName() +": Clear cache");
		}
