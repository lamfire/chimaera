...
public class Utils {
	...
	/**
	 * empty string is used as dummy value to represent null values in
	 * HashSet and TreeSet
	 */
	...
	private static final Comparator COMPARABLE_COMPARATOR = new Comparator<Comparable<Object>>() {
		public int compare(Comparable<Object> o1, Comparable<Object> o2) {
			return o1 == null && o2 != null ? -1 : (o1 != null && o2 == null ? 1 : o1.compareTo(o2));
		}
	};

	public static String formatSpaceUsage(long size) {
		if (size < 1e4)
			return size + "B";
		else if (size < 1e7)
	...
	public static boolean allZeros(byte[] b) {
	...
	public static <E> E max(E e1, E e2, Comparator<E> comp) {
		if (e1 == null)
			return e2;
		if (e2 == null)
			return e1;
	...
	public static <E> E min(E e1, E e2, Comparator<E> comp) {
		if (e1 == null)
			return e2;
		if (e2 == null)
			return e1;
