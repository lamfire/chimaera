...
class DBStore extends DBAbstract {
    ...
    private <A> long insert(A obj, Serializer<A> serializer, DataInputOutput buf)
            throws IOException {
        buf.reset();
    ...
    private <A> void update(long logRecid, final A obj, final Serializer<A> serializer, final DataInputOutput buf)
            throws IOException {
    ...
    private <A> A fetch(long recid, final Serializer<A> serializer, final DataInputOutput buf)
            throws IOException {
