...
public class PersistenceLinkedList<E> extends AbstractSequentialList<E> {
	...
	PersistenceLinkedList(DBAbstract db, long rootRecid, Serializer<E> valueSerializer) {
		this.db = db;
	...
	PersistenceLinkedList(DBAbstract db, Serializer<E> valueSerializer) throws IOException {
		this.db = db;
	 ...
	 */
	static PersistenceLinkedList deserialize(DataInput is, Serialization ser) throws IOException, ClassNotFoundException {
		...
		return new PersistenceLinkedList(ser.db, rootrecid, serializer);
	}
